...
**Core agent runtime and tooling implemented. All 258 tests pass locally.** Lot dependency at rev `30bd25f`. Flick dependency at rev `c827fda`. CI fully green: Windows, Linux, macOS. Linux CI runs tests in parallel (ETXTBSY fix in lot).
